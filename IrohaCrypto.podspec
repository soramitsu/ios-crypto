...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/soramitsu/ios-crypto.git', :tag => s.version.to_s }
...
#    ir.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 arm64' }
...
#  end
  ...
  s.subspec 'sr25519' do |sr|
    ...
    sr.vendored_frameworks = 'sr25519Imp/libsr25519crust.xcframework'
    sr.preserve_paths = 'sr25519Imp/**/*.h'
  end

  s.subspec 'blake2' do |b2|
    b2.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 arm64'  }
    ...
    b2.vendored_frameworks = 'blake2Imp/libblake2.xcframework'
  ...
  s.subspec 'ed25519' do |ed|
    ed.pod_target_xcconfig = { 'VALID_ARCHS' => 'x86_64 arm64'  }
    ...
    ed.vendored_frameworks = 'ed25519Imp/libed25519_sha2.xcframework'
